...
public class BeatMinecraftSpeedrunTask extends Task {
    ...
    protected boolean isEqual(Task task) {
        return task instanceof BeatMinecraftSpeedrunTask;
    }

    @Override
    protected String toDebugString() {
        return "Speeding the run.";
    }
        ...
        if in the overworld:
          if end portal found:
            ...
            if we don't have diamond gear:
              ...
              @get
          if we don't hadiamond gear
            @go to the nether
        if in the nether:ve enough blaze rods:
